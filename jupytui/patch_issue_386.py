# I'm having a similar issue to urwid/urwid#386 on github. 
# I was suggested this patch by ulidtko. Thanks!
# Hopefully I understand the error at some point.
# Commenting out the lines checking if `cursor != c.cursor` in ListBox's `render` function.
